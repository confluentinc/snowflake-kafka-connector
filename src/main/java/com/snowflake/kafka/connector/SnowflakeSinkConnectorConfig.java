...
public class SnowflakeSinkConnectorConfig {
  ...
  public static final String TASK_TO_TOPIC_PARTITIONS_VALIDATION_INTERVAL_MS_DEFAULT = "300000"; // 5 minutes
  public static final String TASK_TO_TOPIC_PARTITIONS_MEMORY_LIMIT_IN_BYTES =
      "task.to.topic.partitions.memory.limit.bytes";
  public static final String TASK_TO_TOPIC_PARTITIONS_MEMORY_LIMIT_IN_BYTES_DEFAULT = "524288000"; // 500MB
