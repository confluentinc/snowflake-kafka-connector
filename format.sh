...
DOWNLOAD_URL="https://github.com/google/google-java-format/releases/download/v1.19.2/google-java-format-1.19.2-all-deps.jar"
JAR_FILE="./.cache/google-java-format-1.19.2-all-deps.jar"
